...
import CustomModal from '../../components/webcam/webcam.modal';
        ...
        return (
            <div className="texted-editor">
                ...
                <div className="actions-bar">
                     <Button variant="outlined"   className="action-button" style={{margin:"0 15px",fontSize:12,textTransform:"capitalize",borderColor:"blue",width:"85%",marginBottom:12,display:"flex",justifyContent:"flex-start"}} onClick={()=>{}}><PostAdd style={{marginRight:4}}/>Nouveau</Button>
                    ...
                    <Button variant="outlined"  className="action-button" style={{margin:"0 15px",fontSize:12,textTransform:"capitalize" ,borderColor:"blue",width:"85%",display:"flex",justifyContent:"flex-start"}} onClick={()=>{}}><ExitToApp style={{marginRight:4}} /> Quitter</Button>
                </div>
            </div>
        );
}
